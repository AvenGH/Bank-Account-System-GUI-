...
class CreateAccountWindow:
    def __init__(self, root, dimensions="750x575"):
        self.root = root
    ...
    def create_ui(self):
        ...
        self.show_password_image = ctk.CTkImage(dark_image = Image.open(resource_path("images/show_password.jpg")), size=(25, 25))
        self.hide_password_image = ctk.CTkImage(dark_image = Image.open(resource_path("images/hide_password.jpg")), size=(25, 25))
        ...
        self.register_window.title("Bank Account System")
        ...
        #Fields that takes in the user's opening balance
        self.opening_balance_label = ctk.CTkLabel(master=self.frame, text="Opening Balance", font=("Arial", 18))
        self.opening_balance_label.place(x=100, y=400)

        self.opening_balance = ctk.CTkEntry(master=self.frame, width=240, height=35, font=("Arial", 16), placeholder_text="Enter your opening balance...")
        self.opening_balance.place(x=275, y=400)
        ...
        self.submit_button.place(x=200, y=475)
    ...
    def submit(self):
        ...
        if AccountSystem.fields_blank(self.name, self.email, self.password, self.conf_password, self.opening_balance):
            tk.messagebox.showerror("Error", "All fields are required!")
            return
        
        # Checks if the sign up was successful
        signed_up = AccountSystem.sign_up(self.name, self.email, self.password, self.conf_password, self.opening_balance)
        if signed_up:
